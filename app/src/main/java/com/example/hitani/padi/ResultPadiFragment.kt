...
class ResultPadiFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_result_padi, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        descPlant.text = DiagnosaPlant().diagnosisMap[diagnosa]
        ...
        findNavController().navigate(R.id.action_rPadi_to_FirstFragment)}
